...
from tools.cerberus.platform import PYTHON_VERSION
from tools.cerberus.utils import compare_paths_lt, quote_string
...
REMARK = ErrorDefinition(0x99, 'remark')
    ...
    def __repr__(self):
        return "{class_name} @ {memptr} ( " \
               ...
               .format(class_name=self.__class__.__name__, memptr=hex(id(self)),  # noqa: E501
                       ...
                       error_message=quote_string(self.error_message),
...
class BasicErrorHandler(BaseErrorHandler):
    ...
    def _format_message(self, field, error):
        error_message = error.error_message if error.error_message else self.messages[error.code]
