...
from tools.wx.constant.CommonConstants import *
from tools.wx.exception.Exception import RequestException, ResponseException
...
from tools.wx.exception.Exception import *
...
class MultiPartForm(object):
    ...
    def __init__(self, charset='utf-8'):
        ...
        self.form_fields = []
        self.files = []
        self.boundary = "wx_SDK_PYTHON_BOUNDARY"
        return
...
def do_multipart_post(url, query_string=None, headers=None, params=None, multipart_params=None, charset='utf-8',
                      timeout=30):
    url, connection = get_http_connection(url, query_string, timeout)
